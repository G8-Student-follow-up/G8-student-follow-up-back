        ...
        <tr>
            <td align="center" style="padding:40px 20px;">
                <table role="presentation" width="560" cellpadding="0" cellspacing="0" border="0" class="container" style="max-width:560px; width:100%; background-color:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 20px 40px rgba(15,23,42,0.08);">
                    <tr>
                        <td class="header-pad" align="center" style="background-color:#8b5cf6; padding:36px 40px; color:#ffffff;">
                    ...
                    <tr>
                        <td class="content-pad" style="padding:40px; color:#1e293b;">
                            <h2 style="margin:0 0 16px; font-size:18px; font-weight:600; color:#0f172a;">You were mentioned in a comment</h2>
                            <p style="margin:0 0 16px; font-size:15px; line-height:1.6; color:#475569;">
                                <strong>{{ $mentionedBy->name }}</strong> mentioned you in a comment on the card
                                <strong>{{ $card->title }}</strong>.
                            </p>
                            <blockquote style="margin:0 0 24px; padding:16px 20px; background:#f8fafc; border-radius:8px; border-left:4px solid #2563eb; font-size:14px; line-height:1.6; color:#334155;">
                                {{ $commentSnippet }}
                            </blockquote>
                            ...
                            <p style="font-size:13px; color:#94a3b8; margin:0; line-height:1.6;">
                                You are receiving this because someone mentioned you in a comment.
                            </p>
                        </td>
                    </tr>
                </table>
